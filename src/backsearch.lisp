...
;; todo verify whether it can find a solution to a satisfiable problem.
;;      1. life->solution fn [DONE]
;;      2. eval fn. [DONE]
;;      3. pass parent state as solution to SAT generated by its child. [DONE]
;;      4. if it succeeds, then there's an issue with the cl-sat library.
;;      5. if it fails, then there's an issue with life->sat.
;; todo if library issue, report and/or debug it.
;;      if life->sat issue, then fix it.
;; todo conversion of solution back to life.
;; todo that's pretty much it. Test on some kool pictures, write it up.
